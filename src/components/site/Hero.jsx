...
export default function Hero() {
	...
	return (
		<>
			<Helmet>
				<title>
					{SITE.brand} - Wedding & Event Planners in {SITE.city}
				</title>
				<meta
					name="description"
					content={`${SITE.brand} brings together a hand-picked network of décor artists, chefs, beauticians, performers and ritual specialists — orchestrated as one seamless celebration across ${SITE.serviceAreas.join(
						", ",
					)}.`}
				/>
			</Helmet>
			...
			>
				...
				<div className="relative container-x pt-28 sm:pt-32 lg:pt-40 pb-20 lg:pb-28 min-h-[100svh] flex flex-col justify-center">
					<div className="max-w-3xl">
						...
						>
							{SITE.brand} brings together a hand-picked network
							of décor artists, chefs, beauticians, performers and
							ritual specialists — orchestrated as one seamless
							celebration across {SITE.serviceAreas.join(", ")}.
						</p>
