...
export default function About() {
	return (
		<>
			<Helmet>
				<title>About Us - {SITE.brand}</title>
				<meta
					name="description"
					content={`${SITE.brand} is a wedding & event planning studio based in ${SITE.city}, serving ${SITE.serviceAreas.join(", ")}. Founded by ${SITE.founder}, we coordinate a curated network of artists, kitchens, beauticians, performers, drivers and pandits so every ritual flows beautifully into the next.`}
				/>
			</Helmet>
			<section
				id="about"
			...
			>
				<div className="container-x grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
					...
					<div className="lg:col-span-7">
						...
						>
							Weddings, planned with the warmth of family — and
							the rigour of a studio.
						</h2>
						<p
						...
						>
							...
							{SITE.brand} began with a single belief: a wedding
							shouldn't be a stressful logistics project for the
							couple or their parents. We coordinate a curated
							network of artists, kitchens, beauticians,
							performers, drivers and pandits so every ritual
							flows beautifully into the next — and you remain a
							guest at your own celebration.
						</p>
