	...
	return (
		<>
			<Helmet>
				...
				<meta
					name="description"
					content={`Get in touch with ${SITE.brand}, your trusted wedding and event planners in ${SITE.city}. Reach us via phone, WhatsApp, email, or visit our office.`}
				/>
			</Helmet>
			<section
				id="contact"
				...
				<div className="container-x grid lg:grid-cols-12 gap-10">
					<div className="lg:col-span-5">
						...
						<p className="text-muted-foreground mt-5">
							Drop by, call, or message — whichever feels easiest.
